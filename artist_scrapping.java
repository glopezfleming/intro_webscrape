...
public class artist_scrapping {
    ...
    public static void main(String[] args) {
        ...
        try{
            Document document = Jsoup.connect(url).get(); //pulls the whole webpage contents from URL
            Elements artists = document.select(".headline"); //For artist name
            Elements hometowns = document.select(".paragraph_wrapper.center_align");
            Elements stories = document.select(".media_wrapper");


            //System.out.println(artists); cool because it prints out HTML
